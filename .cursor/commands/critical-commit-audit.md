...
2. **Use AGENTS.md** for lint, test, and environment commands after any code change.
...
- IPC, preload bridge, and API-client boundaries touched by the range were traced, not skimmed.
