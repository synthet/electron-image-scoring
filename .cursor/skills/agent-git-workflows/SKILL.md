...
Safe repository operations with `git`, `gh`, `delta`, and optional `gitleaks`.

## Purpose

Inspect and modify version control state with bounded diffs. Align with gallery backlog contract (`/task-claim`, `Closes #N` in PRs).
