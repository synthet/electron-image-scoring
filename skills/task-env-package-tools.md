# Task Environment Package Tools

## Purpose
Use project task runners first: just, mise, direnv, uv, ruff, pyright, node, pnpm, corepack, docker, and docker compose. Do not invent ad hoc workflows before inspecting repo manifests.
