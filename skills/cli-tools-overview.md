...
## Purpose
Use this as the first stop for choosing low-memory CLI tools before inspecting a repository. Prefer text/structural search before embedding indexes.

Tool groups: rg/fd/fzf/tree/eza/zoxide/bat/delta; ast-grep/semgrep/tree-sitter/ctags; git/gh/filter-repo/gitleaks; jq/yq/dasel/sqlite/curl/httpie; just/mise/direnv/uv/ruff/pyright/node/pnpm/corepack/docker; shellcheck/shfmt/prettier/eslint/hadolint/trivy; hyperfine/entr/watchexec/watchman.
