...
| **fff MCP** (`ffgrep`, `fffind`, `fff-multi-grep`) | Repeated repo-wide file/content search when **project** `fff-gallery` MCP is connected | One-off bounded probe; fff not installed | Prefer over many grep tool roundtrips |
