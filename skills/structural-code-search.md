...
## Purpose
Use ast-grep for syntax-aware search/rewrite, Semgrep for rule-based security/code patterns, tree-sitter for parser queries, and universal-ctags for lightweight symbol indexes.
