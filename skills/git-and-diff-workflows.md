...
## Purpose
Safe repository operations with git, gh, delta, git-filter-repo, and gitleaks. Always inspect status before edits and show stat plus focused diffs before finalizing.
