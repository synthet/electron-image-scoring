...
## Purpose
Ready-to-run install blocks for Windows PowerShell, WSL2 Ubuntu, and macOS. Confirm package IDs on locked-down machines with winget search or package-manager search first.
